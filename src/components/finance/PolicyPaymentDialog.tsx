    ...
    try {
      ...
      const { data: incomeInsert, error: incomeError } = await supabase
        ...
        .insert({
          ...
          category: 'cobranza',
          description: `Pago póliza ${payment.policy_clients.insurance_policies.policy_number} - ${payment.policy_clients.clients.name}${hasISRWithholding ? ' (con retención ISR)' : ''}`,
