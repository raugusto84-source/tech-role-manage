        ...
        return <Card key={item.id} className="relative">
              <CardContent className="p-4">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {item.item_type === 'articulo' && <Badge variant="outline">
                            <Package className="w-3 h-3 mr-1" />
                            Artículo
                          </Badge>}
                      </div>
                      
                      {item.service_description && <p className="text-sm text-muted-foreground mb-2">
                      ...
                      {item.item_type === 'articulo' && (item.serial_number || item.supplier_name) && <div className="flex items-center space-x-4 text-sm text-muted-foreground mt-2">
                    ...
                    {canEdit && <div className="ml-4 w-40">
                        {showReadyButtons && item.status !== 'finalizada' ? <Button onClick={() => handleStatusChange(item.id, 'finalizada')} disabled={isUpdating} variant="default" size="sm" className="w-full">
                  ...
                  {item.item_type === 'articulo' && <div className="border-t pt-3">
                      ...
                      }} disabled={isEditingSerial} className="h-7 px-2">
                                  <X className="w-3 h-3" />
                                </Button>
                              </> : <Button size="sm" variant="outline" onClick={() => {
                    ...
                    }} placeholder="Ingrese número de serie" className="h-8 mt-1" disabled={!editableSerialFields.has(item.id) || isEditingSerial} />
                        </div>
                        <div>
                    ...
                    }} placeholder="Nombre del proveedor" className="h-8 mt-1" disabled={!editableSerialFields.has(item.id) || isEditingSerial} />
                        </div>
                        <div className="flex justify-end">
                          {isEditingSerial && <div className="flex items-center text-xs text-muted-foreground">
