...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { paymentId, developmentId, email } = await req.json();
    ...
    const paymentMethodLabel = paymentMethods[payment.payment_method || ''] || payment.payment_method || 'No especificado';
