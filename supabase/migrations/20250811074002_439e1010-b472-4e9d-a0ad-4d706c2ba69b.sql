-- Agregar estado "pendiente_aprobacion" al enum de estado de cotizaciones
ALTER TYPE quote_status ADD VALUE 'pendiente_aprobacion';

-- Crear función para generar orden automáticamente cuando se aprueba una cotización
...
BEGIN
  ...
  IF NEW.status = 'aceptada' AND OLD.status != 'aceptada' THEN
    ...
    INSERT INTO public.orders (
      ...
      NEW.assigned_to,
      NULL, -- Se asignará técnico después
      'pendiente_aprobacion', -- Requiere aprobación del cliente
      NULL,
      NULL
    ...
    LOOP
      INSERT INTO public.order_items (
        ...
        quote_items_record.unit_price,
        0, -- Sin margen adicional, precio ya incluido
...
DROP TRIGGER IF EXISTS trigger_create_order_from_approved_quote ON public.quotes;
