-- Fix the enum value issue in convert_quote_to_order function
...
BEGIN
  ...
  -- Crear la orden - FIX: Use correct enum value
  INSERT INTO public.orders (
    ...
    quote_record.assigned_to,
    NULL,
    'pendiente_aprobacion'::order_status,  -- FIX: Use correct enum value instead of Spanish text
    NULL
