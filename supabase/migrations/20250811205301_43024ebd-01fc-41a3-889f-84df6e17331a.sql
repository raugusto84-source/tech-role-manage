-- Fix function search path issues by dropping with CASCADE
DROP TRIGGER IF EXISTS set_purchase_number ON public.purchases;
DROP FUNCTION IF EXISTS public.handle_new_purchase() CASCADE;
DROP FUNCTION IF EXISTS public.generate_purchase_number() CASCADE;
