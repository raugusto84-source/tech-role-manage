-- Set policy orders to start in 'en_proceso'
-- 1) Update bundle creation function to insert orders with status 'en_proceso'
  ...
  FOR attempt IN 1..5 LOOP
    BEGIN
      ...
      INSERT INTO public.orders (
        ...
        COALESCE(p_service_description, 'Servicio programado bundle '|| new_sched_id::text), 'en_proceso', true, p_priority, p_created_by, policy_name
...
-- 2) Update manual creation function to set 'en_proceso' as well
