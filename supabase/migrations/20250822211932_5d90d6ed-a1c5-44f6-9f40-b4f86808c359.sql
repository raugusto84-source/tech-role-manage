-- Cambiar órdenes de servicios programados para que se creen con status 'pendiente' (ya autorizadas)
-- 1) Actualizar función de bundle creation
...
-- 2) Actualizar función manual para crear órdenes con status 'pendiente'  
