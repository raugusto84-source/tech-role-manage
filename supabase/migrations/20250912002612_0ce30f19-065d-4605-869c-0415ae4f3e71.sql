-- Fix rounding source precedence in pending_collections: prefer item totals over estimated_cost
...
WITH item_totals AS (
  ...
  SELECT 
    ...
    -- Base total before rounding (PRIORITY: approved_total -> item totals -> estimated)
    COALESCE(
      o.approved_total,
