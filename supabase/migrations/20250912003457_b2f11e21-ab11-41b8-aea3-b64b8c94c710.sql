-- Adjust precedence in pending_collections: prefer item totals over approved_total and fallback to estimated_cost
...
WITH item_totals AS (
  ...
  SELECT 
    ...
    -- Base total before rounding (PRIORITY: item totals -> approved_total -> estimated)
    COALESCE(
