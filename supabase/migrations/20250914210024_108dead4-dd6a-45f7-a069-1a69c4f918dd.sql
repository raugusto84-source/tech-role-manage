-- Actualizar función convert_quote_to_order para preservar totales exactos de cotización
...
BEGIN
  ...
  INSERT INTO public.orders (
    ...
    quote_record.estimated_amount, -- Usar el total de la cotización directamente
  ...
  -- Calcular el total exacto de la cotización (suma de todos los totales con IVA)
  SELECT COALESCE(SUM(qi.total), 0) INTO order_total
  ...
  -- Actualizar orden con el total exacto de la cotización
  UPDATE public.orders 
  SET 
    estimated_cost = order_total, -- Usar el total calculado de los items
  ...
  RETURN json_build_object(
    ...
    'total_amount', order_total, -- Devolver el total exacto
    'estimated_delivery_date', new_estimated_delivery
  );
