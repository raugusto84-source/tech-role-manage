-- Drop and recreate the function to fix pending collections calculation
DROP FUNCTION IF EXISTS public.manage_pending_collections();
...
DROP FUNCTION IF EXISTS public.update_pending_collections_on_items();
