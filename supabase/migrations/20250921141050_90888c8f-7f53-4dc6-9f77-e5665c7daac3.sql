-- Drop existing cashback triggers and functions
DROP TRIGGER IF EXISTS calculate_cashback_on_delivery_signature_trigger ON public.delivery_signatures;
DROP FUNCTION IF EXISTS public.calculate_cashback_on_delivery_signature();

-- Create function to calculate cashback when order is fully paid
