-- Optimized clean_workflow_data function using TRUNCATE for better performance
...
BEGIN
  ...
  -- TRUNCATE is significantly faster than DELETE for large tables
  
  -- 1. Truncate workflow TDR tracking (new tables)
