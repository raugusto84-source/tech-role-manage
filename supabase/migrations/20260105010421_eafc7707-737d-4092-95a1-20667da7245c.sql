-- Update clean_workflow_data to include payrolls table
...
DECLARE
  tables_to_truncate TEXT[] := ARRAY[
    ...
    'reward_transactions',
    'client_rewards',
    -- Finance - including payrolls (pending), employee_payments, and recurring payrolls
    'fiscal_withdrawals',
    'order_payments',
    'employee_payments',
    'payrolls',
    ...
    'expenses',
    'incomes',
    -- Policies (pólizas) - policy_payments BEFORE policy_clients (FK dependency)
    'policy_payments',
    'policy_visits',
    'scheduled_services',
    'policy_equipment',
